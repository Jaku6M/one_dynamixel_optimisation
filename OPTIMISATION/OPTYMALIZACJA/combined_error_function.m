...
function combined_error = combined_error_function(RealFile, Gazebo_raw_File, params)
    ...
    python_script_path = '/home/jaku6m/Humanoid_workspace/src/one_dynamixel_simulation/launch/OptimizationMX28ARChangeVals.py';
    command = sprintf('gnome-terminal -- python3 %s %f %f %f %f %f %f %f %f %f', python_script_path, params);
    system(command);
    pause(1);
    % Call simulation
    system('python3 /home/jaku6m/Humanoid_workspace/src/one_dynamixel_simulation/launch/OptimizationMX28RunSimulationandTrajectory.py');
    pause(1);
