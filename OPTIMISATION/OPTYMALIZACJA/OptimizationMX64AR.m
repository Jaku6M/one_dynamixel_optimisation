clear;
clc;
RealFile = '/home/jaku6m/Desktop/Plots/RealMX64Plots/Trajectory3.csv';
...
initial_guess = [0.45, 3.7, 0.5, 0.01, 0.7, 0.45, 45.2, 0.0, 0.0];
...
[opt_params, fval] = patternsearch(@(params) combined_error_functionMX64AR(RealFile, Gazebo_raw_File, params), initial_guess, [], [], [], [], lower_bounds, upper_bounds, [], options);
